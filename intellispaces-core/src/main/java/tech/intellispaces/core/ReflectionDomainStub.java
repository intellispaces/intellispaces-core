...
class ReflectionDomainStub implements ReflectionDomainPoint {

  static final ReflectionDomainStub INSTANCE = new ReflectionDomainStub();

  private ReflectionDomainStub() {}
